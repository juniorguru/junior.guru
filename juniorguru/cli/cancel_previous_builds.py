...
def main(circleci_branch, circleci_workflow_id, production, circleci_api_key):
    ...
    pipelines = circleci.get_project_pipelines('honzajavorek', 'junior.guru',
                                               branch=circleci_branch, paginate=True)
    ...
    for pipeline in pipelines:
        ...
        running_workflows.update((workflow['id'], workflow) for workflow in workflows
