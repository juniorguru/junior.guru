...
def render_sth(context):
    return dedent(
        ...
        **Za co platíš** 🧐
        Díky penězům z předplatného může <@{ClubMemberID.HONZA}> provozovat a rozvíjet junior.guru na plný úvazek. Stará se o klub, organizuje přednášky, programuje mě, píše kapitoly do příručky a mnoho dalšího. Cena je nastavena na úplné minimum, aby si klub mohlo dovolit pokud možno co nejvíc lidí.
