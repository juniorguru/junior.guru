...
RULES_EN = rules([
    ...
    rule('EXPLICITLY_JUNIOR', [r'junior', r'padawan']),
...
SUPPRESSING_RULES_EN = rules([
    ...
    rule('EXPLICITLY_SENIOR', r'collaborate', r'with', r'(engineer|developer)s?'),
...
RULES_CS = rules([
    ...
    rule('EXPLICITLY_JUNIOR', [r'junior\w*', r'jnr', r'padawan\w*', r'učeň']),
    ...
    rule('JUNIOR_FRIENDLY', r'vhodn\w+', [r'student\w*', r'absolvent\w*']),
    ...
    rule('JUNIOR_FRIENDLY', r'[Pp]ráce', r'PC', ignorecase=False),
