...
RULES_EN = rules([
    ...
    rule('EXPLICITLY_JUNIOR', [r'junior', r'padawan', r'internship']),
...
RULES_CS = rules([
    ...
    rule('JUNIOR_FRIENDLY', [r'společně', r'spolupr[aá]c\w+'], r'se?', r'senior\w+'),
    ...
    rule('JUNIOR_FRIENDLY', [r'pomůž\w+', r'pomoc'], [r'\w+učit', r'\w+učen\w+'], any_order=True),
    rule('JUNIOR_FRIENDLY', [r'pomůž\w+', r'pomoc'], r'rádi', any_order=True),
...
SUPPRESSING_RULES_CS = rules([
    ...
    rule('ADVANCED_REQUIRED', r'získ\w+', r'(rozhled|přehled)\w*'),
