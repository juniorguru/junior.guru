...
from coop.cli.sync import confirm, default_from_env, main as cli
from coop.lib import loggers, mutations
from coop.models.transaction import Transaction, TransactionsCategory
from coop.sync.transactions.categories_spec import CATEGORIES_SPEC
...
@click.option(
    "--history-path",
    default="coop/data/transactions.jsonl",
