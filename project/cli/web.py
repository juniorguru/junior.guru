...
from project.web_legacy.__main__ import main as flask_freeze
...
def build_static(output_path: Path):
    ...
    shutil.copytree(
        "project/images/screenshots-overrides",
...
@click.argument(
    "config",
    default="project/web/mkdocs.yml",
...
def serve(context, output_path: Path, open: bool):
    ...
    server.watch("project/**/*.js", rebuild_static)
    server.watch("project/**/*.scss", rebuild_static)
    server.watch("project/images/", rebuild_static)
    server.watch("project/data/", rebuild_flask_and_mkdocs, ignore=ignore_data)
    server.watch("project/lib/", rebuild_flask_and_mkdocs)
    server.watch("project/models/", rebuild_flask_and_mkdocs)
    server.watch("project/web/", rebuild_mkdocs)
    server.watch("project/web_legacy/", rebuild_flask_and_mkdocs)
    server.serve(
        host="localhost",
