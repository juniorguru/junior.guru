...
from project.lib.discord_club import ClubClient, get_user_roles, resolve_references
...
from project.models.documented_role import DocumentedRole
from project.models.event import Event
from project.models.mentor import Mentor
from project.models.partner import Partnership


IMAGES_DIR = Path("project/images")

YAML_PATH = Path("project/data/roles.yml")
