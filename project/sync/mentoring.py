...
from project.lib.discord_club import ClubChannelID, ClubClient
...
DATA_PATH = Path("project/data/mentors.yml")
...
async def sync_mentoring(client: ClubClient):
    ...
    info_mentor_description = (
        ...
        "Potom napiš Honzovi, přidá tě do [seznamu](https://github.com/juniorguru/junior.guru/blob/main/project/data/mentors.yml)."
    )
    info_params = dict(
