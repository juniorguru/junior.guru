...
from project.lib.coupons import parse_coupon
from project.lib.memberful import MemberfulAPI
...
from project.models.subscription import (
...
@click.option(
    "--history-path",
    default="project/data/subscription_activities.jsonl",
