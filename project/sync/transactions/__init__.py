...
from project.cli.sync import confirm, default_from_env, main as cli
from project.lib import loggers, mutations
from project.models.transaction import Transaction, TransactionsCategory
from project.sync.transactions.categories_spec import CATEGORIES_SPEC
...
@click.option(
    "--history-path",
    default="project/data/transactions.jsonl",
