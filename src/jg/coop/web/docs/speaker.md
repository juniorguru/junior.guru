...
{% call figure('static/figures/discord-voice-channels.webp', 'Snímek obrazovky, Discord') %}
...
{% call figure('static/figures/discord-voice-call.webp', 'Snímek obrazovky, Discord') %}
