...
{% call figure('static/figures/discord-voice-channels.png', 'Snímek obrazovky, Discord') %}
...
{% call figure('static/figures/discord-voice-call.png', 'Snímek obrazovky, Discord') %}
