...
{% call lead() %}
Vrtá ti hlavou, jak přesně funguje klub? Prolétni si tuto stránku, třeba najdeš odpovědi. Pokud ne, neváhej a piš na {{ 'honza@junior.guru'|email_link }}.
{% endcall %}
...
## Co mám z členství jako senior(ka)?  {: #seniori }
...
## Co mám z členství jako profesionál(ka) na volné noze?  {: #freelanceri }
...
## Co mám z členství jako recruiter(ka)?  {: #recruiteri }
...
## Co mám z členství jako komunitní manažer(ka)?  {: #komunitaci }
