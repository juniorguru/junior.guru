...
{% call figure('static/figures/git-home.png', 'webovka Gitu', 2050, 770) %}
...
{% call figure('static/figures/github-repo.png', 'repozitář na GitHubu', 2694, 1119) %}
...
{% call figure('static/figures/github-data-rozhlas.png', 'organizace na GitHubu', 2694, 1570) %}
