...
{% call figure('static/figures/github-hankaesha.png', 'Profil Hanky Milotové') %}
...
{% call figure('static/figures/github-profile-links.png', 'Odkazy Honzy Javorka') %}
...
{% call figure('static/figures/github-profile-pins.png', 'Repozitáře Petra Viktorina') %}
...
{% call figure('static/figures/github-profile-descriptions.png', 'Repozitáře uživatele Baraker42') %}
...
{% call figure('static/figures/github-archived.png', 'Archivovaný repozitář') %}
...
{% call figure('static/figures/github-profile-readme.png', 'Mia Bajić') %}
...
{{ figure('static/figures/github-chart.png', 'Zelené čtverečky') }}
