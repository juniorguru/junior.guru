...
Přijmi to za své a házej všechno na GitHub, jako vidlema seno. Dílčí cvičení? Šup tam s nimi. Nejrůznější nedodělané pokusy? Taky! Jak už bylo zmíněno, aspoň můžeš snadno někomu svůj kód poslat, když se zasekneš a budeš potřebovat [pomoc](help.md), nebo když budeš chtít zpětnou vazbu.
...
{% call figure('static/figures/github-hankaesha.webp', 'Profil Hanky Milotové') %}
...
{% call figure('static/figures/github-profile-links.webp', 'Odkazy Honzy Javorka') %}
...
{% call figure('static/figures/github-profile-pins.webp', 'Repozitáře Petra Viktorina') %}
...
{% call figure('static/figures/github-profile-descriptions.webp', 'Repozitáře uživatele Baraker42') %}
...
{% call figure('static/figures/github-archived.webp', 'Archivovaný repozitář') %}
...
{% call figure('static/figures/github-profile-readme.webp', 'Mia Bajić') %}
...
{{ figure('static/figures/github-chart.webp', 'Zelené čtverečky') }}
