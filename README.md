...
The junior.guru project monolith: website, Discord bot, and synchronization scripts.
...
1.  Save the obtained JSON file into the `project/sync` directory as `google_service_account.json`
1.  Make sure it is ignored by Git
1.  Run `cat project/sync/google_service_account.json | pbcopy` to copy the JSON into your clipboard (macOS)
