...
1.  Save the obtained JSON file into the `jg/coop/sync` directory as `google_service_account.json`
1.  Make sure it is ignored by Git
1.  Run `cat jg/coop/sync/google_service_account.json | pbcopy` to copy the JSON into your clipboard (macOS)
