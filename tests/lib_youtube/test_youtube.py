...
def test_parse_youtube_info():
    ...
    assert info.model_dump() == {
        ...
        "chapters": [
            ...
            "Nástroje na tvorbu CV",
            "Šablona CV pro switchery do IT",
            "Vzhled",
            "Dobře čitelný text",
            "Písmo",
            "Velikosti písma",
            "Vyznačování",
            "Logické celky a nadpisy",
            "Vynucené zalomení řádku",
            "Odkazy",
            "Odrážky",
            "Zarovnání textu",
            "Kdy porušit pravidla",
            "Délka CV (a jak zkrátit)",
            "Barvy",
            "Otázky",
            "Message from our sponsor",
            "Ukončení přednášky",
            "Ukončení přenosu: Honza Javorek",
