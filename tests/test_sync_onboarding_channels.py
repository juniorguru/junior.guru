...
def test_prepare_channels_operations_close_channels_for_missing_members():
    ...
    channel2 = StubTextChannel(
        "alice-foo-tipy", "Tipy a soukromý kanál jen pro tebe! 🦸 Alice Foo #2"
    )
    channel3 = StubTextChannel(
        "alice-foo-tipy", "Tipy a soukromý kanál jen pro tebe! 🦸 Alice Foo #3"
    )
