...
def test_format_title(kwargs, expected):
    podcast_episode = PodcastEpisode(number=1, guest_name='Adéla', guest_affiliation='Company', title="about testing")
...
def test_format_title_with_no_affiliation(kwargs, expected):
    podcast_episode = PodcastEpisode(number=1, guest_name='Adéla', title="about testing")
