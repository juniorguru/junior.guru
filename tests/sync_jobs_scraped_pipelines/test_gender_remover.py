...
from jg.core.sync.jobs_scraped.pipelines.gender_remover import process
...
@pytest.mark.parametrize(
    ...
    [
        ...
        ("Search Engine Backend Engineer (m/f)", "Search Engine Backend Engineer"),
        (
        ...
        ("JAVA BPM SOFTWARE DEVELOPER (M/F)", "JAVA BPM SOFTWARE DEVELOPER"),
        ("Frontend Engineer (m/f/div)", "Frontend Engineer"),
        ("Junior Fullstack Developer (m/w/d)", "Junior Fullstack Developer"),
        ("Java Developer (m/w)", "Java Developer"),
        ("Software Engineer Ruby/Go (f/m/*)", "Software Engineer Ruby/Go"),
        (
            "C/Ada Software Developer & Tester Aviation (m/f/d )(Ref.-Nr.: 2020)",
            "C/Ada Software Developer & Tester Aviation (Ref.-Nr.: 2020)",
        ),
        ("Solution Engineer (M/F/X)", "Solution Engineer"),
        (
            "UI Frontend Engineer | React JS Developer f/m/x",
            "UI Frontend Engineer | React JS Developer",
        ),
        ("Junior iOS Engineer (Swift) (m|f|x)", "Junior iOS Engineer (Swift)"),
        ("Archer Developer (m/f/diverse)", "Archer Developer"),
        (
            "Tech Trainee Programme (Java-JavaScript-iOS-Android) (d/f/m)",
            "Tech Trainee Programme (Java-JavaScript-iOS-Android)",
        ),
        # French
        ("Internship: JAVA DEVELOPER - H/F", "Internship: JAVA DEVELOPER"),
        # Czech
        (
        ...
        ("Junior ABAP Developer (all genders)", "Junior ABAP Developer"),
    ],
)
@pytest.mark.asyncio
