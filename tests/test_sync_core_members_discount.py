...
import pytest
from juniorguru.sync.core_members_discount import is_recent_reminder, repr_members, get_discount_info
...
def test_get_discount_info():
 ...
 {'amountOffCents': 10000,
  ...
  'isPercentage': True}]
    ...
    assert get_discount_info(coupons, 'coremember') == {'coupon': 'COREMEMBER1234567', 'ptc_off': 10}
