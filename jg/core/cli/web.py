...
from jg.core.web_legacy.__main__ import main as flask_freeze
...
def build_static(output_path: Path):
    ...
    shutil.copytree(
        "jg/core/images/screenshots-overrides",
...
@click.argument(
    "config",
    default="jg/core/web/mkdocs.yml",
...
def serve(context, output_path: Path, open: bool):
    ...
    server.watch("jg/core/**/*.js", rebuild_static)
    server.watch("jg/core/**/*.scss", rebuild_static)
    server.watch("jg/core/images/", rebuild_static)
    server.watch("jg/core/data/", rebuild_flask_and_mkdocs, ignore=ignore_data)
    server.watch("jg/core/lib/", rebuild_flask_and_mkdocs)
    server.watch("jg/core/models/", rebuild_flask_and_mkdocs)
    server.watch("jg/core/web/", rebuild_mkdocs)
    server.watch("jg/core/web_legacy/", rebuild_flask_and_mkdocs)
    server.serve(
        host="localhost",
