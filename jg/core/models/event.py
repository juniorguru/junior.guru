...
from jg.core.lib.charts import month_range, ttm_range
from jg.core.lib.md import strip_links
from jg.core.models.base import BaseModel, JSONField
...
class Event(BaseModel):
    ...
    bio = TextField()
    avatar_path = CharField(default="icon.png")
    bio_name = TextField()
