...
from jg.core.cli.sync import confirm, default_from_env, main as cli
from jg.core.lib import loggers, mutations
from jg.core.models.transaction import Transaction, TransactionsCategory
from jg.core.sync.transactions.categories_spec import CATEGORIES_SPEC
...
@click.option(
    "--history-path",
    default="jg/core/data/transactions.jsonl",
