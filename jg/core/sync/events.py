...
from jg.core.lib.mutations import MutationsNotAllowedError, mutating_discord
from jg.core.lib.template_filters import local_time, md, weekday
...
DATA_PATH = Path("jg/core/data/events.yml")
