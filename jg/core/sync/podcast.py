...
from jg.core.lib.discord_club import ClubChannelID, ClubClient, ClubMemberID
from jg.core.lib.images import (
    PostersCache,
    is_image,
    render_image_file,
    validate_image,
)
from jg.core.lib.mutations import mutating_discord
from jg.core.lib.template_filters import icon
from jg.core.lib.yaml import Date
from jg.core.models.base import db
from jg.core.models.club import ClubMessage
from jg.core.models.feminine_name import FeminineName
from jg.core.models.partner import Partner
...
YAML_PATH = Path("jg/core/data/podcast.yml")
...
IMAGES_DIR = Path("jg/core/images")
